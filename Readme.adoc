...
===Requirements
On the Host system: Install Ansible [e.g. yum install ansible]
On the Gateway: Download JBOSS Fuse 6.2.1 from the https://access.redhat.com/jbossnetwork/restricted/listSoftware.html?product=jboss.fuse&downloadType=distributions[Red Hat Customer Portal] and save it Downloads folder
