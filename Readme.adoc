...
==== We can verify that the Camel route has been deployed by logging into JBOSS Fuse admin cosole: instructions here <https://github.com/ishuverma/Virtual-IoT_Summit_Lab/tree/Virtual-Lab-1/RoutingService#verify-that-the-camel-route-has-been-deployed>
