 ...
 * Update the host file [Virtual-IoT-Gateway/Ansible/host] with IP address of the Gateway and place the public key of the host on the remote Gateway (For instructions look https://github.com/ishuverma/Virtual_IoT_Gateway/tree/Virtual-Lab-1/Ansible[here])
